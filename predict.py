...
def predict(
    ...
    Required Parameters:
        input_audio (CogPath): Upload your audio file here.
    ...
    Optional Parameters:
        ...
        pitch_change (float): Adjust pitch of AI vocals in semitones. Use positive values to increase pitch, negative to decrease. Defaults to 0.
        index_rate (float): Control how much of the AI's accent to leave in the vocals. 0 <= INDEX_RATE <= 1. Defaults to 0.5.
        filter_radius (int): If >=3: apply median filtering to the harvested pitch results. 0 <= FILTER_RADIUS <= 7. Defaults to 3.
        ...
        f0_method (str): Pitch detection algorithm. 'rmvpe' for clarity in vocals, 'mangio-crepe' for smoother vocals. Defaults to "rmvpe".
        crepe_hop_length (int): Controls how often it checks for pitch changes in milliseconds when using mangio-crepe algo specifically. Lower values lead to longer conversions and higher risk of voice cracks, but better pitch accuracy. Defaults to 128.
